...
# ★★★ 待機時間を大幅短縮 ★★★
SHORT_WAIT = 0.5 # 短い待機時間を短縮 (1.0→0.3秒)
MEDIUM_WAIT = 0.8 # 中程度の待機時間を短縮 (1.3→0.5秒)
LONG_WAIT = 1.0 # 長い待機時間を短縮 (1.5→0.7秒)
# ★★★ 英語ページでのJSレンダリング待機時間短縮 ★★★
JS_RENDER_WAIT = 0.5 # 秒 (大幅短縮 1.0→0.3秒)
