        ...
        try:
            ...
            js_switch_to_en = """
                ...
                if (langBtn) {
                    ...
                    // If no button, try to modify URL params
            ...
            # Short wait depending on whether we used a button or navigated
            if used_button:
                # Button click just needs a short wait
                time.sleep(SHORT_WAIT)
            else:
                # URL navigation needs to wait for page load
                WebDriverWait(driver, min(30, ELEMENT_WAIT_TIMEOUT)).until(
                    EC.presence_of_element_located((By.TAG_NAME, "body"))
                )
