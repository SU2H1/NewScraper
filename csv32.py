...
def process_single_url(syllabus_url, year, screenshots_dir, opened_links_this_year_field, auth_cookies=None):
    """Process a single syllabus URL using tabs to preserve the main window state"""
    ...
    try:
        ...
        # Open a new tab instead of direct navigation
        ...
        # Try to recover by closing the tab and returning to main window if possible
        try:
