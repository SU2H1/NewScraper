                            ...
                            if current_active_page_num in processed_page_numbers:
                                ...
                                try:
                                    ...
                                    if len(urls_on_page) > 0:
                                        ...
                                        # Replace the section from line ~840 with this:
                                        for index, syllabus_url in enumerate(urls_on_page):
                                            ...
                                            try:
                                                ...
                                                if details:
                                                    ...
                                                    opened_links_this_year_field.add(syllabus_url)  # Only mark as processed if successful
                                                    processed_count_on_page += 1
                                                    consecutive_errors = 0
                                                    print(f"           ✅ 成功: {syllabus_url}")
                                                else:
                                                    print(f"           ❌ 失敗 (詳細なし): {syllabus_url}")
                                                    field_error_count += 1
                                                    consecutive_errors += 1
                                            except Exception as e:
                                                print(f"           ❌ エラー: {syllabus_url}: {str(e)}")
                                                field_error_count += 1
                                                consecutive_errors += 1
